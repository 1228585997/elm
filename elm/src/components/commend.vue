      ...
      <div class="rating_header">
        <headtop>
          ...
          <template v-slot:exchange>
            ...
            <div class="title_head ellipsis title_head1">推荐有奖</div>
          </template>
        </headtop>
        <div class="activity_banner">
          <img src="http://elm.cangdu.org/elm/static/img/activity.png" />
        </div>
        <div class="invite_firend">
          <div class="invite_firend_style" @click="btn">
...
.invite_firend_style img {
  width: 80px;
  height: 80px;
}
.invite_firend_style p {
  font-size: 20px;
  line-height: 30px;
  color: #333;
}
