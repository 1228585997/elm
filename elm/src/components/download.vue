		...
		<headtop>
			<template v-slot:download>
				<router-link to="/profile">
					<van-icon name="arrow-left" class="arrow-down" size="20px"/>
				</router-link>
