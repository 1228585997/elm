	...
	export default {
		...
		methods:{
			search_submit(){
				...
				this.$http.get(`https://elm.cangdu.org/v4/restaurants?geohash=${this.geohash}&keyword=${this.valtext}`).then((res)=>{
...
<style scoped>
	...
	.item_right_textp,.item_right_textp1{
		line-height:35px;
	}
